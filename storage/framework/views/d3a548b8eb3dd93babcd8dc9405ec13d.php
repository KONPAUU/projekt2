<div class="teacher-sidebar shadow-lg" id="teacher-sidebar">
    ...
    <div class="sidebar-nav">
        <nav class="nav flex-column">
            <!-- Dashboard -->
            <a href="<?php echo e(route('teacher.dashboard')); ?>" class="nav-item <?php echo e(request()->routeIs('teacher.dashboard') ? 'active' : ''); ?>">
                <div class="nav-icon">
            ...
            <div class="nav-section">
                ...
                <a href="<?php echo e(route('teacher.grades.index')); ?>" class="nav-item <?php echo e(request()->routeIs('teacher.grades.index') ? 'active' : ''); ?>">
                    <div class="nav-icon">
                ...
                <a href="<?php echo e(route('teacher.grades.create')); ?>" class="nav-item <?php echo e(request()->routeIs('teacher.grades.create') ? 'active' : ''); ?>">
                    <div class="nav-icon">
                ...
                <a href="<?php echo e(route('teacher.grades.quick')); ?>" class="nav-item <?php echo e(request()->routeIs('teacher.grades.quick') ? 'active' : ''); ?>">
                    <div class="nav-icon">
            ...
            <div class="nav-section">
                ...
                <a href="<?php echo e(route('teacher.students.index')); ?>" class="nav-item <?php echo e(request()->routeIs('teacher.students.*') ? 'active' : ''); ?>">
                    <div class="nav-icon">
                ...
                <a href="<?php echo e(route('teacher.subjects.index')); ?>" class="nav-item <?php echo e(request()->routeIs('teacher.subjects.*') ? 'active' : ''); ?>">
                    <div class="nav-icon">
            ...
            <div class="nav-section">
                ...
                <a href="<?php echo e(route('teacher.attendance.index')); ?>" class="nav-item <?php echo e(request()->routeIs('teacher.attendance.index') ? 'active' : ''); ?>">
                    <div class="nav-icon">
                ...
                <a href="<?php echo e(route('teacher.attendance.reports')); ?>" class="nav-item <?php echo e(request()->routeIs('teacher.attendance.reports') ? 'active' : ''); ?>">
                    <div class="nav-icon">
...
</style><?php /**PATH C:\Users\Dominik\Desktop\dziennik\dziennik-lekcyjny\resources\views/layouts/partials/teacher-sidebar.blade.php ENDPATH**/ ?>