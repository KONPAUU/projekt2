<?php $__env->startSection('title', 'Zarządzanie Użytkownikami'); ?>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($stats['students']); ?></div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($stats['teachers']); ?></div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($stats['admins']); ?></div>
                            </div>
                            <div class="col-auto">
        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="input-group">
                            <input type="text" class="form-control" id="searchInput" placeholder="Wyszukaj użytkowników..." value="<?php echo e(request('search')); ?>">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-<?php echo e($user->role->name == 'admin' ? 'danger' : ($user->role->name == 'teacher' ? 'primary' : 'success')); ?>">
                                ...
                                <td>
                                    <?php if($user->schoolClass): ?>
                                        <span class="badge bg-light text-dark"><?php echo e($user->schoolClass->name); ?></span>
                                    <?php else: ?>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm" role="group">
                                        <a href="<?php echo e(route('admin.users.show', $user)); ?>" class="btn btn-outline-info" title="Zobacz">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="<?php echo e(route('admin.users.edit', $user)); ?>" class="btn btn-outline-primary" title="Edytuj">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <?php if($user->id !== auth()->id()): ?>
                                        <button type="button" class="btn btn-outline-danger" onclick="deleteUser(<?php echo e($user->id); ?>)" title="Usuń">
                ...
                <div class="d-flex justify-content-center mt-4">
                    <?php echo e($users->appends(request()->query())->links('vendor.pagination.custom')); ?>
        ...
        <div class="modal-content">
            ...
            <form method="GET" action="<?php echo e(route('admin.users.index')); ?>">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" name="role" id="role">
                                ...
                                <option value="teacher" <?php echo e(request('role') == 'teacher' ? 'selected' : ''); ?>>Nauczyciel</option>
                                <option value="student" <?php echo e(request('role') == 'student' ? 'selected' : ''); ?>>Uczeń</option>
                            </select>
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" name="status" id="status">
                                ...
                                <option value="active" <?php echo e(request('status') == 'active' ? 'selected' : ''); ?>>Aktywny</option>
                                <option value="inactive" <?php echo e(request('status') == 'inactive' ? 'selected' : ''); ?>>Nieaktywny</option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3">
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?php echo e(route('admin.users.index')); ?>" class="btn btn-outline-warning">Wyczyść</a>
...
function searchUsers() {
    ...
    window.location.href = `<?php echo e(route('admin.users.index')); ?>?search=${encodeURIComponent(searchTerm)}`;
}
...
function exportUsers() {
    window.location.href = '<?php echo e(route("admin.export.pdf")); ?>?type=users';
}
</script>
<?php $__env->stopPush(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\konra\Desktop\dziennik-lekcyjny — kopia (2)\resources\views/admin/users/index.blade.php ENDPATH**/ ?>