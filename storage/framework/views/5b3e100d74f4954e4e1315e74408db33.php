<div class="sidebar-section">
    ...
    <div class="sidebar-nav">
        ...
        <a href="<?php echo e(route('admin.reports')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.reports') ? 'active' : ''); ?>">
            <span class="sidebar-link__icon"><i class="fas fa-chart-line"></i></span>
            <span class="sidebar-link__text">Raporty</span>
            <i class="fas fa-chevron-right sidebar-link__chevron"></i>
        </a>
        <a href="<?php echo e(route('admin.export.pdf')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.export.*') ? 'active' : ''); ?>">
...
<div class="sidebar-section">
    ...
    <div class="sidebar-nav">
        <a href="<?php echo e(route('admin.users.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.users.index') ? 'active' : ''); ?>">
            <span class="sidebar-link__icon"><i class="fas fa-user-group"></i></span>
            <span class="sidebar-link__text">Lista użytkowników</span>
            <i class="fas fa-chevron-right sidebar-link__chevron"></i>
        </a>
        <a href="<?php echo e(route('admin.users.create')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.users.create') ? 'active' : ''); ?>">
...
<div class="sidebar-section">
    ...
    <div class="sidebar-nav">
        <a href="<?php echo e(route('admin.classes.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.classes.index') ? 'active' : ''); ?>">
            <span class="sidebar-link__icon"><i class="fas fa-layer-group"></i></span>
            <span class="sidebar-link__text">Klasy</span>
            <i class="fas fa-chevron-right sidebar-link__chevron"></i>
        </a>
        <a href="<?php echo e(route('admin.classes.create')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.classes.create') ? 'active' : ''); ?>">
            <span class="sidebar-link__icon"><i class="fas fa-plus-circle"></i></span>
            <span class="sidebar-link__text">Nowa klasa</span>
            <i class="fas fa-chevron-right sidebar-link__chevron"></i>
        </a>
        <a href="<?php echo e(route('admin.subjects.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.subjects.index') ? 'active' : ''); ?>">
            <span class="sidebar-link__icon"><i class="fas fa-book"></i></span>
            <span class="sidebar-link__text">Przedmioty</span>
            <i class="fas fa-chevron-right sidebar-link__chevron"></i>
        </a>
        <a href="<?php echo e(route('admin.subjects.create')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.subjects.create') ? 'active' : ''); ?>">
...
<?php /**PATH C:\Users\konra\Desktop\dziennik-lekcyjny — kopia (2)\resources\views/layouts/partials/admin-sidebar.blade.php ENDPATH**/ ?>