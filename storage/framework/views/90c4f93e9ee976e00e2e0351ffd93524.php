<div class="sidebar-section">
    ...
    <div class="sidebar-nav">
        ...
        <a href="<?php echo e(route('teacher.subjects.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('teacher.subjects.*') ? 'active' : ''); ?>">
...
<div class="sidebar-section">
    ...
    <div class="sidebar-nav">
        <a href="<?php echo e(route('teacher.grades.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('teacher.grades.index') ? 'active' : ''); ?>">
            <span class="sidebar-link__icon"><i class="fas fa-list"></i></span>
            <span class="sidebar-link__text">Lista ocen</span>
            <i class="fas fa-chevron-right sidebar-link__chevron"></i>
        </a>
        <a href="<?php echo e(route('teacher.grades.create')); ?>" class="sidebar-link <?php echo e(request()->routeIs('teacher.grades.create') ? 'active' : ''); ?>">
            <span class="sidebar-link__icon"><i class="fas fa-plus"></i></span>
            <span class="sidebar-link__text">Dodaj ocenę</span>
            <i class="fas fa-chevron-right sidebar-link__chevron"></i>
        </a>
        <a href="<?php echo e(route('teacher.grades.history')); ?>" class="sidebar-link <?php echo e(request()->routeIs('teacher.grades.history') ? 'active' : ''); ?>">
...
<div class="sidebar-section">
    ...
    <div class="sidebar-nav">
        <a href="<?php echo e(route('teacher.attendance.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('teacher.attendance.index') ? 'active' : ''); ?>">
            <span class="sidebar-link__icon"><i class="fas fa-user-check"></i></span>
            <span class="sidebar-link__text">Rejestruj obecność</span>
            <i class="fas fa-chevron-right sidebar-link__chevron"></i>
        </a>
        <a href="<?php echo e(route('teacher.attendance.reports')); ?>" class="sidebar-link <?php echo e(request()->routeIs('teacher.attendance.reports') ? 'active' : ''); ?>">
...
<?php /**PATH C:\Users\konra\Desktop\dziennik-lekcyjny — kopia (2)\resources\views/layouts/partials/teacher-sidebar.blade.php ENDPATH**/ ?>