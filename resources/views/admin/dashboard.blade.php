...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="btn-toolbar">
        <div class="btn-group me-2">
            ...
            <a href="{{ route('admin.reports') }}" class="btn btn-success shadow-sm">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h4 mb-0 font-weight-bold">{{ $stats['total_users'] }}</div>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h4 mb-0 font-weight-bold">{{ $stats['total_teachers'] }}</div>
                        <div class="mt-2 mb-0 text-white-50 text-xs">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h4 mb-0 font-weight-bold">{{ number_format($stats['average_grade'], 2) }}</div>
                        <div class="mt-2 mb-0 text-white-50 text-xs">
    ...
    <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
        <div class="card border-0 shadow-sm bg-light">
            <div class="card-body text-center p-3">
                ...
                <div class="fw-bold text-primary">{{ $stats['total_classes'] }}</div>
    ...
    <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
        <div class="card border-0 shadow-sm bg-light">
            <div class="card-body text-center p-3">
                ...
                <div class="fw-bold text-success">{{ $stats['total_subjects'] }}</div>
    ...
    <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
        <div class="card border-0 shadow-sm bg-light">
            <div class="card-body text-center p-3">
                ...
                <div class="fw-bold text-info">{{ $stats['total_grades'] }}</div>
    ...
    <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
        <div class="card border-0 shadow-sm bg-light">
            <div class="card-body text-center p-3">
                ...
                <div class="fw-bold text-warning">{{ $recentGrades->where('created_at', '>=', now()->startOfDay())->count() }}</div>
    ...
    <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
        <div class="card border-0 shadow-sm bg-light">
            <div class="card-body text-center p-3">
                ...
                <div class="fw-bold text-danger">{{ $recentGrades->where('created_at', '>=', now()->subDays(7))->count() }}</div>
    ...
    <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
        <div class="card border-0 shadow-sm bg-light">
            <div class="card-body text-center p-3">
                ...
                <div class="fw-bold text-secondary">{{ $recentGrades->where('created_at', '>=', now()->subDays(30))->count() }}</div>
                    ...
                    <div class="col-6">
                        <div class="border-left-danger pl-3 mb-3">
                            ...
                            <div class="h6 mb-0 font-weight-bold text-gray-800">
                                {{ $recentGrades->where('created_at', '>=', now()->startOfDay())->count() }}
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <small class="text-muted">{{ $grade->student->schoolClass->name ?? 'Brak klasy' }}</small>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <span class="badge bg-{{ $grade->grade >= 5 ? 'success' : ($grade->grade >= 4 ? 'primary' : ($grade->grade >= 3 ? 'warning' : 'danger')) }}">
                                        {{ $grade->grade }}
                                    </span>
                                    <small class="text-muted">(waga: {{ $grade->weight }})</small>
                                </td>
                                <td>
        ...
        <div class="card shadow mt-4">
            ...
            <div class="card-body">
                <div class="text-center">
                    <div class="h4 font-weight-bold text-success">{{ $stats['total_users'] }}</div>
                ...
                <div class="small text-muted">
                    <p class="mb-1"><i class="fas fa-circle text-success"></i> Administratorzy:
                        {{ \App\Models\User::whereHas('role', function($q) { $q->where('name', 'admin'); })->count() }}
                    </p>
                    <p class="mb-1"><i class="fas fa-circle text-primary"></i> Nauczyciele: {{ $stats['total_teachers'] }}</p>
                    <p class="mb-0"><i class="fas fa-circle text-info"></i> Uczniowie: {{ $stats['total_students'] }}</p>
                </div>
            </div>
        </div>
    </div>
                ...
                callbacks: {
                    label: function(context) {
                        return 'Ocena ' + context.label + ': ' + context.parsed + ' (' +
                               Math.round(context.parsed / {{ $stats['total_grades'] }} * 100) + '%)';
                    }
                }
            }
        }
