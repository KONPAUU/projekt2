...
<li class="breadcrumb-item"><a href="{{ route('admin.subjects.index') }}">Przedmioty</a></li>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('category') is-invalid @enderror" id="category" name="category">
                                    ...
                                    <option value="humanistyczne" {{ old('category') == 'humanistyczne' ? 'selected' : '' }}>Przedmioty Humanistyczne</option>
                                    <option value="matematyczno-przyrodnicze" {{ old('category') == 'matematyczno-przyrodnicze' ? 'selected' : '' }}>Matematyczno-Przyrodnicze</option>
                                    <option value="artystyczne" {{ old('category') == 'artystyczne' ? 'selected' : '' }}>Artystyczne</option>
                                    <option value="jezyki" {{ old('category') == 'jezyki' ? 'selected' : '' }}>Języki Obce</option>
                                    <option value="wf" {{ old('category') == 'wf' ? 'selected' : '' }}>Wychowanie Fizyczne</option>
                                    <option value="techniczne" {{ old('category') == 'techniczne' ? 'selected' : '' }}>Techniczne</option>
                                    <option value="zawodowe" {{ old('category') == 'zawodowe' ? 'selected' : '' }}>Zawodowe</option>
                                </select>
                                @error('category')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('icon') is-invalid @enderror"
                                       id="icon" name="icon" value="{{ old('icon', 'book') }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('hours_per_week') is-invalid @enderror"
                                       ...
                                       value="{{ old('hours_per_week') }}" min="1" max="20">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('color') is-invalid @enderror" id="color" name="color">
                                    ...
                                    <option value="primary" {{ old('color') == 'primary' ? 'selected' : '' }}>Niebieski</option>
                                    <option value="success" {{ old('color') == 'success' ? 'selected' : '' }}>Zielony</option>
                                    <option value="info" {{ old('color') == 'info' ? 'selected' : '' }}>Turkusowy</option>
                                    <option value="warning" {{ old('color') == 'warning' ? 'selected' : '' }}>Żółty</option>
                                    <option value="danger" {{ old('color') == 'danger' ? 'selected' : '' }}>Czerwony</option>
                                    <option value="secondary" {{ old('color') == 'secondary' ? 'selected' : '' }}>Szary</option>
                                    <option value="dark" {{ old('color') == 'dark' ? 'selected' : '' }}>Ciemny</option>
                                </select>
                                @error('color')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-12">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                          ...
                                          placeholder="Opisz zakres przedmiotu, cele nauczania, metody oceniania...">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" id="has_final_exam" name="has_final_exam"
                                               value="1" {{ old('has_final_exam') ? 'checked' : '' }}>
