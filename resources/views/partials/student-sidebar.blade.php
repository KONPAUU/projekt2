...
<div class="sidebar-section">
    ...
    <div class="sidebar-nav">
        <a href="{{ route('student.grades.index') }}" class="sidebar-link {{ request()->routeIs('student.grades.index') ? 'active' : '' }}">
        ...
        <a href="{{ route('student.grades.average') }}" class="sidebar-link {{ request()->routeIs('student.grades.average') ? 'active' : '' }}">
            <span class="sidebar-link__icon"><i class="fas fa-scale-balanced"></i></span>
            <span class="sidebar-link__text">Średnie</span>
            <i class="fas fa-chevron-right sidebar-link__chevron"></i>
        </a>
        <a href="{{ route('student.grades.history') }}" class="sidebar-link {{ request()->routeIs('student.grades.history') ? 'active' : '' }}">
            <span class="sidebar-link__icon"><i class="fas fa-clock-rotate-left"></i></span>
            <span class="sidebar-link__text">Historia ocen</span>
            <i class="fas fa-chevron-right sidebar-link__chevron"></i>
        </a>
        <a href="{{ route('student.grades.statistics') }}" class="sidebar-link {{ request()->routeIs('student.grades.statistics') ? 'active' : '' }}">
...
<div class="sidebar-section">
    ...
    <div class="sidebar-nav">
        <a href="{{ route('student.attendance.index') }}" class="sidebar-link {{ request()->routeIs('student.attendance.index') ? 'active' : '' }}">
            <span class="sidebar-link__icon"><i class="fas fa-user-check"></i></span>
            <span class="sidebar-link__text">Podsumowanie</span>
            <i class="fas fa-chevron-right sidebar-link__chevron"></i>
        </a>
        <a href="{{ route('student.attendance.calendar') }}" class="sidebar-link {{ request()->routeIs('student.attendance.calendar') ? 'active' : '' }}">
...
<div class="sidebar-section">
    ...
    <div class="sidebar-nav">
        <a href="{{ route('student.class.info') }}" class="sidebar-link {{ request()->routeIs('student.class.info') ? 'active' : '' }}">
            <span class="sidebar-link__icon"><i class="fas fa-circle-info"></i></span>
            <span class="sidebar-link__text">Informacje</span>
            <i class="fas fa-chevron-right sidebar-link__chevron"></i>
        </a>
        <a href="{{ route('student.class.ranking') }}" class="sidebar-link {{ request()->routeIs('student.class.ranking') ? 'active' : '' }}">
            <span class="sidebar-link__icon"><i class="fas fa-ranking-star"></i></span>
            <span class="sidebar-link__text">Ranking</span>
            <i class="fas fa-chevron-right sidebar-link__chevron"></i>
        </a>
        <a href="{{ route('student.subjects.index') }}" class="sidebar-link {{ request()->routeIs('student.subjects.*') ? 'active' : '' }}">
            <span class="sidebar-link__icon"><i class="fas fa-book-reader"></i></span>
