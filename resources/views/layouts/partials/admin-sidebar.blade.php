    ...
    <div class="sidebar-nav">
        <nav class="nav flex-column">
            ...
            <div class="nav-section">
                ...
                <a href="{{ route('admin.classes.index') }}" class="nav-item {{ request()->routeIs('admin.classes.index') ? 'active' : '' }}">
                    <div class="nav-icon">
                ...
                <a href="{{ route('admin.classes.create') }}" class="nav-item {{ request()->routeIs('admin.classes.create') ? 'active' : '' }}">
                    <div class="nav-icon">
                ...
                <a href="{{ route('admin.subjects.index') }}" class="nav-item {{ request()->routeIs('admin.subjects.index') ? 'active' : '' }}">
                    <div class="nav-icon">
                ...
                <a href="{{ route('admin.subjects.create') }}" class="nav-item {{ request()->routeIs('admin.subjects.create') ? 'active' : '' }}">
                    <div class="nav-icon">
